...
export class ExpoBox extends Component {
    ...
    filterOptions = () => {
        //filter workplaces without logoAbsoluteUrl
            ...
            .filter(
                (ele, ind) =>
                    ...
                    copyWorkplaces.findIndex(
                        (elem) =>
                            elem.Location === ele.Location && elem.id === ele.id
                    )
            )
    ...
    waitingForm = () => {
        return (
            <div className='waitingFormClass'>
                <p>
                    Valitse haluamasi kaupungit vasemmalta hakuehdoista ja
                    karuselli käynnistyy
                </p>
            </div>
        )
    }
        ...
        return (
            <div className='showSearchResultsClass'>
                <p>
                    ...
                    <span className='allWorkplacesNumber'>
                        {allWorkplaces.length}
                    </span>
                    työpaikkaa.
                </p>
            </div>
